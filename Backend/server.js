...
app.use((req, res, next) => {
  ...
  console.log("CORS origin:", origin); // for debugging in Render logs

  // allow requests with no origin (curl, server-to-server)
  if (!origin) {
    // do nothing special, proceed
    return next();
  }

  // if origin is allowed, echo it exactly (required when credentials:true)
